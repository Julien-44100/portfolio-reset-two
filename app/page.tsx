	...
	return (
		<div className={styles.page}>
			...
			<section className={styles.frontendbackend}>
				<section className={`${styles.section} ${styles.slideInFromLeft} ${styles.frontend}`}>
					<h2>Front-End</h2>
					<ul>
						<li>HTML5</li>
						<li>CSS3</li>
				...
				<section className={`${styles.section} ${styles.slideInFromLeft} ${styles.backend}`}>
					<h2>Back-End</h2>
					<ul>
						<li>Express.js</li>
						<li>SQL</li>
			...
			<section className={`${styles.section} ${styles.slideInFromLeft} ${styles.contact}`}>
				...
				<p className={styles.cvandlm}>CV et lettre de motivation à télécharger</p>
